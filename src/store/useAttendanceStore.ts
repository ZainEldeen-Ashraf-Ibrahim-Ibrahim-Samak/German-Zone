...
interface AttendanceState {
  ...
  recordBulk: (sessionId: number, records: { student_id: number; teacher_id?: number | null; status: string; excuse_notes?: string; teacher_status?: 'present' | 'absent' }[]) => Promise<boolean>
